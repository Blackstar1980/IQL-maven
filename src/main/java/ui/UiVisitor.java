...
//			}
//			addDialogPanels(jDialog, query.dialog().getDescription(), panels);
//			jDialog.pack();
...
//	}
//	
//	private void addDialogPanels(JDialog dialog, String description,
...
//	}
//	
//	// Return if the data was saved or not
...
//		value.setFont(new Font(value.getFont().getName(), value.getFont().getStyle(), 20));
//		value.setText("  " + slider.getDefVal());
...
//		StyleId style = (StyleId)constraints.get(ConstraintId.STYLE);
//		return switch (style) {
//			case Block -> setSliderBlockStyle(title, jSlider, value, panel);
//			case Inline -> setSliderInlineStyle(title, jSlider, value, panel);
//			default ->
//			throw new IllegalArgumentException("Unexpected value: " + style);
//		};
//	}
...
//	}
//
////	// TODO merge all constraints validation into one method and remove all repetitive code
////	private String validateStringConstraints(String text, Map<ConstraintId, Constraint> constraints) {
////		if(constraints.get(ConstraintId.REQUIRED) == RequiredCon.Required) {
////			String requiredError = ((Constraint.RequiredCon)constraints.get(ConstraintId.REQUIRED)).validate(text);
////			if(!" ".equals(requiredError))
////				return requiredError;
////		}
////		if(constraints.containsKey(ConstraintId.MIN)) {
////			String minError = ((Constraint.MinCon)constraints.get(ConstraintId.MIN)).validateLength(text);
////			if(!" ".equals(minError))
////				return minError;
////		}
////		if(constraints.containsKey(ConstraintId.MAX)) {
////			String maxError = ((Constraint.MaxCon)constraints.get(ConstraintId.MAX)).validateLength(text);
////			if(!" ".equals(maxError))
////				return maxError;
////		}
////		if(constraints.containsKey(ConstraintId.REGEX)) {
////			String regexError = ((Constraint.RegexCon)constraints.get(ConstraintId.REGEX)).validate(text);
////			if(!" ".equals(regexError))
////				return regexError;
////		}
...
////	}
////	
////	private String validateIntegerConstraints(String text, Map<ConstraintId, Constraint> constraints) {
////		if(constraints.get(ConstraintId.REQUIRED) == RequiredCon.Required) {
////			String requiredError = ((Constraint.RequiredCon)constraints.get(ConstraintId.REQUIRED)).validate(text);
////			if(!" ".equals(requiredError))
////				return requiredError;
////		}
////		if(constraints.containsKey(ConstraintId.MIN)) {
////			String minError = ((Constraint.MinCon)constraints.get(ConstraintId.MIN)).validateInt(text);
////			if(!" ".equals(minError))
////				return minError;
////		}
////		if(constraints.containsKey(ConstraintId.MAX)) {
////			String maxError = ((Constraint.MaxCon)constraints.get(ConstraintId.MAX)).validateInt(text);
////			if(!" ".equals(maxError))
////				return maxError;
////		}
////		return " ";
////	}
////	
////	private String validateDecimalConstraints(String text, Map<ConstraintId, Constraint> constraints) {
////		if(constraints.get(ConstraintId.REQUIRED) == RequiredCon.Required) {
////			String requiredError = ((Constraint.RequiredCon)constraints.get(ConstraintId.REQUIRED)).validate(text);
////			if(!" ".equals(requiredError))
////				return requiredError;
////		}
////		if(constraints.containsKey(ConstraintId.MIN)) {
////			String minError = ((Constraint.MinCon)constraints.get(ConstraintId.MIN)).validateDec(text);
////			if(!" ".equals(minError))
////				return minError;
////		}
////		if(constraints.containsKey(ConstraintId.MAX)) {
////			String maxError = ((Constraint.MaxCon)constraints.get(ConstraintId.MAX)).validateDec(text);
////			if(!" ".equals(maxError))
////				return maxError;
////		}
////		return " ";
